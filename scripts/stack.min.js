...
var notestack=function(){var a=jQuery.noConflict(),f=function(){a(".show:not(.settings_pane)").removeClass("show");h("off")},h=function(b){b=="off"?(a("html body").removeClass("fullscreen-mode"),a(".overlay").removeClass("show")):b=="on"?(a("html body").addClass("fullscreen-mode"),a(".overlay").addClass("show")):(a("html body").toggleClass("fullscreen-mode"),a(".overlay").toggleClass("show"))},t=function(){query=a(".search input").val().toLowerCase();a(".listnote").each(function(){a(this).data().content.toLowerCase().indexOf(query)>
-1?a(this).removeClass("search-hide"):a(this).addClass("search-hide")});a(".selected:not(.search-hide,.tag-hide)").length==0&&(a(".selected").removeClass("selected"),a(".listnote:not(.search-hide,.tag-hide):first").addClass("selected"));l()},o=function(b,c){a(".status .progress .inner").length==0&&a(".status").html('<div class="progress"><div class="inner"></div></div>');a(".status .progress .inner").animate({width:b+"%"},250,c)},J=a.throttle(500,!0,o),A=function(a){epoch_num=parseFloat(a);return time_dt=
(new Date(epoch_num*1E3)).toISOString()},m=function(){a(".current").length!=1&&(a(".selected").length!=1?(a(".selected").removeClass("selected"),a(".listnote:first").addClass("selected")):a("#"+a(".selected").data().key).addClass("current"));a(".prev2").removeClass("prev2");a(".prev1").removeClass("prev1");a(".next1").removeClass("next1");a(".next2").removeClass("next2");a(".current").prev(".note").prev(".note").addClass("prev2");a(".current").prev(".note").addClass("prev1");a(".current").next(".note").addClass("next1");
a(".current").next(".note").next(".note").addClass("next2")},l=function(){a(".selected").length!=1&&(a(".selected").removeClass("selected"),a(".listnote:first").addClass("selected"));a(".note").remove();var b=a.parseJSON(localStorage.tagIndex).tags,c=[],d;for(d in b)c.push(b[d].name);a(".listnote:not(.search-hide,.tag-hide)").each(function(){a("#note-template").clone().attr("id",a(this).data().key).addClass("note").appendTo(".window");var b=a("#"+a(this).data().key);b.children(".textarea").children("textarea").val(a(this).data().content);
var d=a(this).data().tags.join(" ");tagfield=b.children(".textarea").children(".tag-area").children("input");tagfield.val(d);tagfield.tagit({singleFieldDelimiter:" ",availableTags:c}).tagit({onTagAdded:function(){u(a(".current").attr("id"))},onTagRemoved:function(b,c){tagName=c.children(".tagit-label").text();u(a(".current").attr("id"),tagName)}})});a("#"+a(".selected").data().key).addClass("current");B(".note .textarea textarea");m()},B=function(b){a(b).bind("keydown","esc",function(){a(".note-directions").removeClass("show");
a(this).blur()});a(b).tabby();a(".maximize").click(function(){h()});a(".tagsinput div input").blur(function(){u(a(".current").attr("id"))})},p=function(){a(".listnote").sortElements(function(b,c){if(a(b).hasClass("pinned")){if(!a(c).hasClass("pinned"))return-1}else if(a(c).hasClass("pinned")&&!a(b).hasClass("pinned"))return 1;return parseFloat(a(b).data("modifydate"))<parseFloat(a(c).data("modifydate"))?1:-1});return"sorted"},r=function(){nextOne=a(".selected").nextAll(".listnote:not(.search-hide,.tag-hide):first");
nextOne.length>0&&(a(".selected").removeClass("selected"),nextOne.addClass("selected"),a(".current").removeClass("current").next(".note").addClass("current"),m(),C())},s=function(){prevOne=a(".selected").prevAll(".listnote:not(.search-hide,.tag-hide):first");prevOne.length>0&&(a(".selected").removeClass("selected"),prevOne.addClass("selected"),a(".current").removeClass("current").prev(".note").addClass("current"),m(),C())},D=function(){createdate=(new Date).getTime();newid="notestack"+createdate;
newdata={key:newid,createdate:createdate/1E3,modifydate:createdate/1E3,tags:[],systemtags:[],content:"new note"};localStorage.setItem(newid,JSON.stringify(newdata));index=a.parseJSON(localStorage.index);index.data.push(newdata);localStorage.index=JSON.stringify(index);n(newid);p();a(".selected").removeClass("selected");a("#list-"+newid).addClass("selected");l();a(".current .textarea textarea").select()},C=function(){a(".selected").position().top<0&&a(".list").scrollTop(a(".list").scrollTop()+a(".selected").position().top);
a(".selected").position().top+a(".listnote").height()>a(".list").height()&&a(".list").scrollTop(a(".list").scrollTop()+a(".selected").position().top-a(".list").height()+a(".listnote").height())},K=function(){a(".version-item").sortElements(function(b,c){return parseFloat(a(b).data("version"))<parseFloat(a(c).data("version"))?1:-1});return"sorted"},L=function(b,c){return a.Deferred(function(d){a.ajax("/sn.php",{type:"POST",data:{action:"noteversion",email:email,token:token,notekey:b,noteversion:c},
success:function(c){note=a.parseJSON(c);a("#version-template").clone().attr("id",b+"version"+note.version).addClass("version-item").appendTo(".versions .versions-left").data(note);thisversion=a("#"+b+"version"+note.version);thisversion.children(".version-date").html('<abbr class="timeago" title="'+A(note.versiondate)+'"></abbr>');a(".timeago").timeago();K();d.resolve()},error:function(){return"false"}})}).promise()},M=function(b){a(".version-item").remove();var c=[];noteobj=a.parseJSON(localStorage.getItem(b));
curversion=noteobj.version;for(i=minversion=noteobj.minversion;i<=curversion;i++)c.push(L(b,i));a.when.apply(null,c).done(function(){a(".version-item").each(function(){if(a(this).data().version>minversion){prev=a(this).data().version-1;var c=a("#"+b+"version"+prev).data().content,k=a(this).data().content,g=new diff_match_patch,c=g.diff_main(c,k);g.diff_cleanupSemantic(c);ds=g.diff_prettyHtml(c);a(this).data("diff",ds)}});a(".versions-right .right-inner").html(a(".version-item:first").data().diff);
a(".version-item:first").addClass("version-select")})},E=function(b){a(".versions").hasClass("show")?f():(h("off"),a(".versions").addClass("show"),a(".overlay").addClass("show"),a(".versions-right .right-inner").html(""),M(b))},N=function(){return a.Deferred(function(b){postData={action:"tagIndex",email:localStorage.email,token:localStorage.token};a.ajax("/sn.php",{type:"POST",data:postData,timeout:3E3,success:function(a){if(a=="401")window.location="/?login=expired";localStorage.tagIndex=a;b.resolve()},
error:function(){a(".status").text("Working offline. Changes will sync when connected.");a(".status-div").removeClass("loading")}})})},v=function(){a(".labels").hasClass("show")?f():(h("off"),O(),a(".labels").addClass("show"),a(".overlay").addClass("show"),a(".labels input").val("").select());return!1},O=function(){a(".labels .item").remove();var b=a.parseJSON(localStorage.tagIndex);a(".listnote");for(i=0;i<b.count;i++)tagname=b.tags[i].name,tagid=tagname.replace("@","").replace(".",""),j=0,a(".listnote").each(function(){a.inArray(tagname,
a(this).data().tags)>-1&&(console.log(tagname+a(this).data().tags),j++)}),a("#label-template").clone().attr("id",tagid).addClass("item").appendTo(".labels .items"),a("#"+tagid).children(".name").html("<pre>"+tagname+"</pre>"),a("#"+tagid).children(".notecount").text(j+" notes");a(".labels .item").sortElements(function(b,d){return parseFloat(a(b).children(".notecount").text())<parseFloat(a(d).children(".notecount").text())?1:-1})},P=function(){query=a(".labels input").val().toLowerCase();a(".labels .item").each(function(){a(this).children(".name").text().toLowerCase().indexOf(query)>
-1?a(this).removeClass("hide"):a(this).addClass("hide")});a(".label-select").removeClass("label-select");a(".labels .item:not(.hide):first").addClass("label-select")},u=function(b,c){var d=a("#"+b+" .tag-area input").val().split(" "),k=d.indexOf(c);k!=-1&&d.splice(k,1);note=a.parseJSON(localStorage[b]);if(note.tags!=d)note.tags=d,note.syncnum+=1,localStorage[b]=JSON.stringify(note),n(b),q()},w=function(b){a(".labels input").val("").blur();F();f();a("html body").addClass("tag-filter");a("#tag-filter-template").clone().attr("id",
"").addClass("active-tag-filter").insertBefore(".list");a(".active-tag-filter .inner .tag-filter-label").text(b);a(".listnote").each(function(){a.inArray(b,a(this).data().tags)&&a(this).addClass("tag-hide")});a(".selected").removeClass("selected");a(".listnote:not(.search-hide,.tag-hide):first").addClass("selected");l()},F=function(){a("html body").removeClass("tag-filter");a(".active-tag-filter").remove();a(".listnote").removeClass("tag-hide");a(".selected").removeClass("selected");a(".listnote:not(.search-hide,.tag-hide):first").addClass("selected");
l()},G=function(b){return a.Deferred(function(c){a.ajax("/sn.php",{type:"POST",data:{action:"note",email:email,token:token,notekey:b},success:function(b){note=a.parseJSON(b);localStorage.setItem(note.key,b);n(note.key);c.resolve()},error:function(){}})}).promise()},H=function(b){var c=a.Deferred(),d={action:"sendnote",email:email,token:token,notekey:b.key,notebody:JSON.stringify(b)};if(b.key.substr(0,9)=="notestack")delete d.notekey,delete b.key,d.notebody=JSON.stringify(b);a.ajax("/sn.php",{type:"POST",
data:d,success:function(d){note=a.parseJSON(d);if(!("content"in note))note.content=b.content;index=a.parseJSON(localStorage.index);for(i=0;i<=index.data.length-1;i++)if(index.data[i].key.substr(0,9)=="notestack"){a("#list-"+index.data[i].key).remove();localStorage.removeItem(index.data[i].key);index.data.splice(i,1);break}localStorage.index=JSON.stringify(index);localStorage.setItem(note.key,JSON.stringify(note));n(note.key);a("#list-"+note.key).addClass("selected");p();l();c.resolve()},error:function(){}});
return c.promise()},Q=function(){return a.Deferred(function(b){function c(h){for(d=k;d<=k+h;d++){J(50+Math.round(50*(d/index.data.length)));if(!index.data[d]){b.resolve();var o=!0;break}localStorage.getItem(index.data[d].key)?(localNote=a.parseJSON(localStorage.getItem(index.data[d].key)),localNote.key.substr(0,9)=="notestack"?g.push(H(localNote)):localNote.syncnum<index.data[d].syncnum?g.push(G(localNote.key)):localNote.syncnum>index.data[d].syncnum?g.push(H(localNote)):n(localNote.key)):g.push(G(index.data[d].key));
index.data[d].deleted==0?f++:index.data[d].deleted==1&&m++}if(o==!0)return!1;g.length>0?a.when.apply(null,g).done(function(){k=k+h+1;g=[];p();l();c(h)}):(k=k+h+1,g=[],c(h))}index=a.parseJSON(localStorage.index);var d=0,k=0,g=[],f=0,m=0;c(20);a(".note-data").text(f+" notes | ");a(".data_notes").text(f);a(".data_deleted").text(m)}).promise()},I=function(b){return a.Deferred(function(c){a.ajax("/sn.php",{type:"POST",data:b,timeout:5E3,success:function(d){if(d=="401")window.location="/?login=expired";
newIndex=a.parseJSON(d);if(localStorage.index){existingIndex=a.parseJSON(localStorage.index);for(i=0;i<=newIndex.data.length-1;i++){for(j=0;j<=existingIndex.data.length-1;j++)if(existingIndex.data[j].key==newIndex.data[i].key){existingIndex.data.splice(j,1);break}existingIndex.data.push(newIndex.data[i])}existingIndex.count=existingIndex.data.length}else existingIndex=newIndex;localStorage.setItem("mark",newIndex.mark?newIndex.mark:"DONE");localStorage.setItem("index",JSON.stringify(existingIndex));
localStorage.setItem("indexDate",newIndex.time);localStorage.mark=="DONE"?(localStorage.removeItem("mark"),c.resolve()):(b.mark=localStorage.mark,a.when(I(b)).done(function(){c.resolve()}))},error:function(){a(".status").text("Working offline. Changes will sync when connected.");a(".status-div").removeClass("loading")}})}).promise()},q=function(b){localStorage.token?a.when(N()).done(function(){o(25);b=="full"?mark=since="":localStorage.mark?(since="",mark=localStorage.mark):(since=localStorage.indexDate?
localStorage.indexDate:"",mark="");email=localStorage.email;token=localStorage.token;a.when(I({action:"index",email:email,token:token,since:since,mark:mark,length:100})).done(function(){o(50);(new Date).getTime();a.when(Q()).done(function(){o(100,function(){indexDate=A(localStorage.indexDate);a(".status").html('synced <abbr class="timeago" title="'+indexDate+'"></abbr>');a(".timeago").timeago();a(".status-div").removeClass("loading");p();l()})})})}):window.location="/"},n=function(b){return a.Deferred(function(c){note=
a.parseJSON(localStorage.getItem(b));note.deleted!=1&&(a("#list-"+note.key).length>0?a("#list-"+note.key).removeData().data(note):a("#listnote-template").clone().attr("id","list-"+note.key).addClass("listnote").appendTo(".list").data(note),thisnote=a("#list-"+note.key),thisnote.removeClass("pinned"),thisnote.data().systemtags.indexOf("pinned")>-1&&thisnote.addClass("pinned"),titlebreak=thisnote.data().content.indexOf("\n"),titlebreak<0?(thisnote.children(".title").text(thisnote.data().content.substring(0,
100)),thisnote.children(".preview").text("")):(thisnote.children(".title").text(thisnote.data().content.substring(0,titlebreak)),thisnote.children(".preview").text(thisnote.data().content.substr(titlebreak,100))),c.resolve())}).promise()},x=function(b){var c=a("html body").attr("class").split(" ");i=0;for(len=c.length;i<len;i++)c[i].substr(0,6)=="theme-"&&(c[i]="");a(".appearance .item.theme").siblings(".theme").addClass("dim");a("#"+b).removeClass("dim");a("html body").attr("class",c.join(" "));
a("html body").addClass(b);localStorage.theme=b},y=function(b){var c=a("html body").attr("class").split(" ");i=0;for(len=c.length;i<len;i++)c[i].substr(0,5)=="font-"&&(c[i]="");a(".appearance .font").siblings(".font").addClass("dim");a("#"+b).removeClass("dim");a("html body").attr("class",c.join(" "));a("html body").addClass(b);localStorage.font=b},z=function(b){var c=a("html body").attr("class").split(" ");i=0;for(len=c.length;i<len;i++)c[i].substr(0,9)=="fontsize-"&&(c[i]="");a(".appearance .fontsize").siblings(".fontsize").addClass("dim");
a("#"+b).removeClass("dim");a("html body").attr("class",c.join(" "));a("html body").addClass(b);localStorage.fontsize=b},R=function(){localStorage.theme?(themename=localStorage.theme,x(themename)):x("theme-moleskine");a(".appearance .item.theme").click(function(){themename=a(this).attr("id");a(this).removeClass("dim");x(themename)});localStorage.font?(fontname=localStorage.font,y(fontname)):y("font-mono");a(".appearance .font").click(function(){var b=a(this).attr("id");y(b)});localStorage.fontsize?
(fontsize=localStorage.fontsize,z(fontsize)):z("fontsize-12");a(".appearance .fontsize").click(function(){var b=a(this).attr("id");z(b)});localStorage.tagPref=="no-tags"&&(a("html body").addClass("no-tags"),a(".tag-pref").addClass("dim"));a(".appearance .tag-pref").click(function(){a(this).hasClass("dim")?(a(this).removeClass("dim"),a("html body").removeClass("no-tags"),localStorage.removeItem("tagPref")):(a(this).addClass("dim"),a("html body").addClass("no-tags"),localStorage.setItem("tagPref","no-tags"))});
a(".note .textarea textarea").live("focus",function(){a(".current .note-directions").addClass("show");a("div.current").addClass("highlight")});a(".note .textarea textarea").live("blur",function(){blurkey=a(this).parent().parent().attr("id");if(a(this).val()!=a("#list-"+blurkey).data().content)blurnote=a.parseJSON(localStorage.getItem(blurkey)),blurnote.content=a(this).val(),blurnote.modifydate=(new Date).getTime()/1E3,blurnote.syncnum+=1,localStorage.setItem(blurkey,JSON.stringify(blurnote)),n(blurnote.key),
q();a(".current .note-directions").removeClass("show");a(".current").removeClass("highlight")});a(".addnote").click(function(){D()});a(".tags").click(function(){v()});a(".reload").click(function(){q()});a(".close").click(function(){f()});a(".delete").live("click",function(){a(this).parent().children(".message").toggleClass("show").html('Mark this note as deleted?  <a href="#" class="confirmDelete">Delete</a> / <a href="#" class="cancelDelete">Cancel</a>')});a(".confirmDelete").live("click",function(){var b=
notekey=a(this).parent().parent().attr("id");note=a("#list-"+b).data();note.deleted=1;note.modifydate=(new Date).getTime()/1E3;note.syncnum+=1;localStorage.setItem(note.key,JSON.stringify(note));a("#list-"+b).remove();a("#"+b).remove();a(".listnote:first").addClass(".selected");l();return!1});a(".cancelDelete").live("click",function(){a(".message").removeClass("show");return!1});a(".listnote").live("click",function(){a(".selected").removeClass("selected");a(this).addClass("selected");a(".current").removeClass("current");
a("#"+a(this).attr("id").split("list-").pop()).addClass("current");m()});a(".note").live("click",function(){a(".current").removeClass("current");a(this).addClass("current");a(".selected").removeClass("selected");a("#list-"+a(this).attr("id")).addClass("selected");m()});a(".settings_icon").click(function(){a(".settings").toggleClass("show")});a(".userdata").click(function(){a(".settings").toggleClass("show");a(".settings_pane").removeClass("show");a(".settings_pane.data").addClass("show")});a(".settings .tabs a").click(function(){a(".settings_pane").removeClass("show");
a(".settings_pane."+a(this).text().replace(" ","_")).addClass("show");e.preventDefault();return!1});a(".versions-button").live("mousedown",function(){notekey=a(this).parent().attr("id");E(notekey)});a(".version-item").live("mousedown",function(){a(".diff-view").hasClass("depressed")?a(".versions-right .right-inner").html(a(this).data().diff):a(".versions-right .right-inner").html('<textarea disabled="disabled">'+a(this).data().content+"</textarea>");a(".version-select").removeClass("version-select");
a(this).addClass("version-select")});a(".versions-toolbar .diff-view,.versions-toolbar .text-view").live("mousedown",function(){a(".versions-toolbar .depressed").removeClass("depressed");a(this).addClass("depressed");a(".version-select").length<1&&a(".version-item:first").addClass(".version-select");a(this).hasClass("diff-view")?a(".versions-right .right-inner").html(a(".version-select").data().diff):a(this).hasClass("text-view")&&a(".versions-right .right-inner").html('<textarea disabled="disabled">'+
a(".version-select").data().content+"</textarea>")});a(".overlay").click(function(){f()});a(".versions-toolbar .revert-version").live("mousedown",function(){if(a(".version-select").length==1)return notekey=a(".version-select").attr("id").split("version").shift(),verContent=a(".version-select").data().content,a(".selected").removeClass("selected"),a("#list-"+notekey).addClass("selected"),a(".current").removeClass("current"),a("#"+notekey).addClass("current"),m(),f(),a(".note.current .textarea textarea").val(verContent).focus(),
!1});a(".clear-tag-filter").live("mouseup",function(){F()});a(".labels .item").live("mouseup",function(){w(a(this).attr("id"))});a(".tagit-label").live("mouseup",function(){w(a(this).text())});a(".cleardata").click(function(){localStorage.clear()});a(document).bind("keydown","esc",function(){f()});a(document).bind("keydown","j",function(){r()});a(document).bind("keydown","right",function(){r()});a(document).bind("keydown","down",function(){r()});a(document).bind("keydown","k",function(){s()});a(document).bind("keydown",
"left",function(){s()});a(document).bind("keydown","up",function(){s()});a(document).bind("keydown","return",function(){a(".note.current .textarea textarea").focus();return!1});a(document).bind("keydown","tab",function(){a(".note.current .textarea textarea").focus();return!1});a(document).bind("keydown","shift+/",function(){a(".settings").toggleClass("show")});a(document).bind("keydown","/",function(){a(".search input").select();return!1});a(document).bind("keydown","c",function(){D();return!1});
a(document).bind("keydown","s",function(){q();return!1});a(document).bind("keydown","p",function(){var b=a(".selected");b.data().systemtags.indexOf("pinned")>-1?b.data().systemtags.splice(b.data().systemtags.indexOf("pinned"),1):b.data().systemtags.push("pinned");b.data().syncnum=b.data().syncnum+1;localStorage.setItem(b.data().key,JSON.stringify(b.data()));n(b.data().key);p();l()});a(document).bind("keydown","f",function(){h()});a(document).bind("keydown","l",function(){v();return!1});a(document).bind("keydown",
"t",function(){v();return!1});a(document).bind("keydown","v",function(){E(a(".current").attr("id"));return!1});a(document).bind("keydown","a",function(){a("html body").removeClass("tag-filter");a(".active-tag-filter").remove();a(".listnote").removeClass("tag-hide");a(".selected").removeClass("selected");a(".listnote:not(.search-hide,.tag-hide):first").addClass("selected");a(".search input").val("");t();return!1});a(".search input").keyup(a.debounce(250,t));a(".search input").bind("keydown","return",
function(){a(this).blur();return!1});a(".search input").bind("keydown","esc",function(){a(this).val("");t();a(this).blur();return!1});a(".search input").bind("keydown","down",function(){a(this).blur();r();return!1});a(".search input").bind("keydown","up",function(){a(this).blur();s();return!1});a(".labels input").keyup(function(a){a=a.which;a!=38&&a!=40&&a!=13&&P()});a(".labels input").bind("keydown","esc",function(){a(this).val("");a(this).blur();f();return!1});a(".labels input").bind("keydown",
"down",function(){nextOne=a(".label-select").nextAll(".item:not(.hide):first");nextOne.length>0&&(a(".label-select").removeClass("label-select"),nextOne.addClass("label-select"));return!1});a(".labels input").bind("keydown","up",function(){prevOne=a(".label-select").prevAll(".item:not(.hide):first");prevOne.length>0&&(a(".label-select").removeClass("label-select"),prevOne.addClass("label-select"));return!1});a(".labels input").bind("keydown","return",function(){w(a(".label-select .name").text());
return!1});B(".note .textarea textarea")};a(function(){R();if(localStorage.email){a(".username").text(localStorage.email);if(localStorage.index){o(10);if(localStorage.index){index=a.parseJSON(localStorage.index);for(i=0;i<=index.data.length-1;i++)localStorage.getItem(index.data[i].key)!=null&&n(index.data[i].key)}a(".listnote").length>0&&(p(),l())}(new Date).getTime();q()}else window.location="/"})}();